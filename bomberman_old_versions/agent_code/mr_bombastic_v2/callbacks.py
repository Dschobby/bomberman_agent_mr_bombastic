...
def state_to_features(game_state: dict) -> np.array:
    ...
    *This is not a required function, but an idea to structure your code.*
    ...
    right = int(coin_direction_x>0) + int(np.abs(coin_direction_x)>np.abs(coin_direction_y) and coin_direction_x>0)
    left = int(coin_direction_x<0) + int(np.abs(coin_direction_x)>np.abs(coin_direction_y) and coin_direction_x<0)
    up = int(coin_direction_y<0) + int(np.abs(coin_direction_y)>np.abs(coin_direction_x) and coin_direction_y<0)
    down = int(coin_direction_y>0) + int(np.abs(coin_direction_y)>np.abs(coin_direction_x) and coin_direction_y>0)
